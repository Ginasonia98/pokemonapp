...
function BigCardTypes({ types }) {
  return (
    <div className="mt-0 xl:mt-4">
      <p className="text-lg xl:text-2xl text-purple-500 font-bold justify-center xl:text-start mb-2">
        Type
      </p>
      <div className="flex space-x-2 justify-center xl:justify-start text-white">
